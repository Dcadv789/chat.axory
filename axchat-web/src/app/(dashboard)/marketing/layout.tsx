...
/**
 * Trava do add-on de Marketing. Fica no layout pra valer em `/marketing` e em
 * toda seção (`/marketing/conteudo`, `/marketing/anuncios`…) sem repetir a
 * checagem em cada página — uma seção nova nasceria destrancada.
 */
  ...
  if (!marketingEnabled) {
    return (
      <div className="flex h-full items-center justify-center p-6">
        <div className="mx-auto max-w-lg rounded-xl border border-dashed border-zinc-300 bg-white p-10 text-center dark:border-white/10 dark:bg-black">
