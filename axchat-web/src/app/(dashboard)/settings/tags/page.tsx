            ...
            <div key={tag.id} className="flex items-center justify-between rounded-lg border border-zinc-200 bg-white px-4 py-3 dark:border-white/10 dark:bg-black">
              {editingId === tag.id ? (
                <div className="flex flex-1 items-center gap-3">
                  ...
                  <button onClick={() => setEditingId(null)} className="rounded px-3 py-1 text-xs text-zinc-500 hover:bg-zinc-100 dark:hover:bg-white/10">Cancelar</button>
                </div>
              ) : (
                <>
                  ...
                  <div className="flex gap-1">
                    <button onClick={() => startEdit(tag)} className="rounded p-1.5 text-zinc-400 hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-white/10">
