      ...
      <div className="mt-6 space-y-2">
        {isLoading ? (
          ...
          keys.map((key) => (
            <div
              key={key.id}
              className="flex items-center justify-between rounded-lg border border-zinc-200 bg-white px-4 py-3 dark:border-white/10 dark:bg-black"
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-zinc-800 dark:text-zinc-200">{key.name}</span>
                  <code className="rounded bg-zinc-100 px-1.5 py-0.5 font-mono text-xs text-zinc-600 dark:bg-black dark:text-zinc-400">
                    {key.prefix}…
                  </code>
                </div>
          ...
          <div className="w-full max-w-lg rounded-lg border border-zinc-200 bg-white shadow-xl dark:border-white/10 dark:bg-black">
            ...
            <div className="space-y-4 px-5 py-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <code className="flex-1 truncate rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 font-mono text-xs text-zinc-800 dark:border-white/10 dark:bg-black dark:text-zinc-200">
                    {createdKey.rawKey}
                  </code>
                  <button
                    onClick={handleCopy}
              ...
              <div className="rounded-md border border-zinc-200 bg-zinc-50 p-3 dark:border-white/10 dark:bg-black">
