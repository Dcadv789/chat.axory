...
export interface LlmCompletionRequest {
  ...
  /**
   * Organização dona da chamada. Quando presente, o LlmService busca a
   * chave de API do provider configurada por essa org (ex: DeepSeek pela UI)
   * e usa ela em vez da env var global. Ausente = só fallback de env.
   */
