...
export class UpdateOrganizationDto {
  ...
  @ApiPropertyOptional({
    description:
      'Chave de API do DeepSeek desta organização. Enviar a string para definir; enviar null ou string vazia para limpar (volta a usar o fallback global DEEPSEEK_API_KEY da env). O GET nunca devolve a chave em texto puro.',
    nullable: true,
  })
  @IsOptional()
  @ValidateIf((_, value) => value !== null)
