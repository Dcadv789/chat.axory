...
import { ReplyInstagramCommentHandler } from './handlers/reply-instagram-comment.handler';
...
export class ActionRegistryService implements OnModuleInit {
  ...
  constructor(
    ...
    private readonly replyInstagramComment: ReplyInstagramCommentHandler,
  ) {}
